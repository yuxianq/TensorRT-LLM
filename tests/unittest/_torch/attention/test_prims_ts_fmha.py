...
def test_generation_wrapper_plans_once_and_reads_live_native_csr(
    ...
    assert fmha._decode_wrapper_plan_key is not None
    assert fmha._decode_wrapper_plan_key[-1] is fmha._enable_pdl
...
def test_decode_pdl_environment_is_snapshotted_and_threaded_to_plan(
    ...
    assert fmha._decode_wrapper_plan_key is not None
    assert fmha._decode_wrapper_plan_key[-1] is True
