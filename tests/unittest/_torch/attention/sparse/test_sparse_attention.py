...
import tensorrt_llm
from tensorrt_llm._torch.attention.backends import block_sparse
from tensorrt_llm._torch.attention.backends.interface import (
    AttentionForwardArgs,
    AttentionInputType,
)
from tensorrt_llm._torch.attention.backends.sparse import hooks as sparse_hooks
from tensorrt_llm._torch.attention.backends.sparse import params as sparse_params_module
...
def test_skip_softmax_uses_an_algorithm_specific_trtllm_backend() -> None:
    from tensorrt_llm._torch.attention.backends.sparse.registry import (
...
def test_skip_softmax_backend_preserves_existing_prediction_payload() -> None:
    ...
    from tensorrt_llm._torch.attention.backends.sparse.skip_softmax.backend import (
...
def test_dsa_prediction_attaches_nvfp4_scratch_pointer(
    ...
    from tensorrt_llm._torch.attention.backends.sparse.dsa.backend import DSATrtllmAttention
