...
- `fmha/prims_ts.py` adapts TRT-LLM QKV preprocessing and paged-cache metadata
  ...
  [`flashinfer/attention/prims_ts` source](https://github.com/yuxianq/flashinfer/tree/b0fee1f03dc61b9872435a73b02056ff172d5e8d/flashinfer/attention/prims_ts)
  from the `trtllm-prims-ts-reusable-wrappers` branch of
  [`yuxianq/flashinfer`](https://github.com/yuxianq/flashinfer) at commit
  `b0fee1f03dc61b9872435a73b02056ff172d5e8d`, excludes the upstream README
